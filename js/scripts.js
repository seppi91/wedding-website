$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            end: new Date('Jun 16, 2024 03:00'),

            // Event Address
            address: 'Weingut Kaiserberg, Lindenbergstraße 69, 76829 Landau in der Pfalz',

            // Event Description
            description: "Schön das du kommst! Wir freuen uns schon dich zu sehen. Bei Fragen oder Anliegen, zögere nicht uns zu kontaktieren."
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbxM8T6dzXukVdyViEAL41GXA5JCYJ3Fi__YEnSvwc4hCTED_NPIUeeOHCprnQirl30ndA/exec', data)
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Entschuldigung!</strong> Da ist leider etwas schiefgegangen. '));
                });
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 49.22245, lng: 8.1019815};
